# -*- coding: utf-8 -*-
#
# versionah documentation build configuration file, created by
...
htmlhelp_basename = 'versionahdoc'
...
latex_documents = [
  ('index', 'versionah.tex', u'versionah Documentation',
   u'James Rowe', 'manual'),
]
...
man_pages = [
    ('index', 'versionah', u'versionah Documentation',
     [u'James Rowe'], 1)
]
