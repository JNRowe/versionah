...
@step(u'I have the Version object for (%(VERSION)s) and (?:tuple|string) (%(VERSION)s)')
...
@step(u'I have the Version object for (%(VERSION)s) and RegExp matcher for (%(VERSION)s)')
